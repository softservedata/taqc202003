...
public class UITestNG {
    ...
    public Object[][] searchData() {
        return new Object[][] {
                  {new ProductItems("MacBook"), new ProductItems("iPhone 3"), new ProductItems("3") },  
        };
    }
	...
	public void CartTest(ProductItems product1 , ProductItems product2, ProductItems amount ) throws Exception {
		//MAC
